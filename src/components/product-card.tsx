...
import ImageViewer from "./commerce-ui/image-viewer";
...
function ProductCard({
  ...
  return (
    <div className="group relative flex w-[300px] flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
      {/* Gradient badge  */}
      {tagText && (
      ...
      <div className="flex flex-1 flex-col gap-4 px-5">
        ...
        <div className="flex items-center gap-x-3 pb-4">
          <Button
            variant="outline"
            onClick={onAddToCart}
            className="w-full max-w-fit border-gray-300 bg-white text-gray-800 transition-all duration-200 hover:border-indigo-500 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:border-indigo-500 dark:hover:bg-gray-700"
          >
            Add to cart
          </Button>
          <Button
            onClick={onBuyNow}
            className="w-full max-w-fit bg-gradient-to-r from-indigo-600 to-purple-600 text-white transition-all hover:from-indigo-700 hover:to-purple-700"
          >
            Buy now
          </Button>
        </div>
