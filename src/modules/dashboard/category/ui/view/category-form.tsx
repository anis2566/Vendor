...
import { defaultCategorySlugs } from "@/constant";
...
export const CategoryForm = () => {
    ...
    const { mutate: createCategory, isPending } = useMutation(trpc.category.create.mutationOptions({
        onError: (error) => {
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <MultiSelect
                                            options={defaultCategorySlugs.map((item) => ({
                                                label: item,
                                                value: item,
                                            }))}
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between border p-3 shadow-sm">
                                    <div className="space-y-0.5">
                                        ...
                                        <FormDescription>
                                            Toggle this status to enable or disable the category
