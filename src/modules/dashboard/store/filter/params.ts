...
export const storeSearchParams = createLoader(filterParmas);

const applicationFilterParmas = {
  search: parseAsString.withDefault("").withOptions({ clearOnDefault: true }),
  page: parseAsInteger
    .withDefault(DEFAULT_PAGE)
    .withOptions({ clearOnDefault: true }),
...
export const applicationSearchParams = createLoader(applicationFilterParmas);
